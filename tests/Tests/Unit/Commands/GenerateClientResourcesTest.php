...
it('generates all the client files into our tmp folder', function () {
    ...
    foreach (['Category', 'CategoryPost', 'Post', 'Secret', 'User'] as $typeName) {
        $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/models/'.$typeName.'.ts', (string)File::get($this->base . '/frontend/models/'.$typeName.'.ts'));
        ...
        $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/components/forms/'.$typeName.'Form.vue', (string)File::get($this->base . '/frontend/components/forms/'.$typeName.'Form.vue'));
    ...
    $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/enums/CollectionName.ts', (string)File::get($this->base . '/frontend/enums/CollectionName.ts'));
    ...
    $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/stores/collections.ts', (string)File::get($this->base . '/frontend/stores/collections.ts'));
    ...
    $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/components.ts', (string)File::get($this->base . '/frontend/components.ts'));
    ...
    foreach (['categories', 'category_posts', 'posts', 'secrets', 'users'] as $typeName) {
        $updateFixtures && $this->setFixture(__DIR__ . '/Fixtures/stores/collections/'.$typeName.'.ts', (string)File::get($this->base . '/frontend/stores/collections/'.$typeName.'.ts'));
